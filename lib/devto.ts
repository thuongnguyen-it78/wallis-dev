...
export const getAllArticles = async (): Promise<IArticle[]> => {
    ...
    // const headers = { 'api-key': "eyJfcmFpbHMiOnsibWVzc2FnZSI6IlcxczVPRFV3T1RkZExDSk5TRFI0ZWpObWNIcHpObFkyUVhwak1USnlhU0lzSWpFMk56QXpNVEV6TXpndU9URTFOalF4TXlKZCIsImV4cCI6IjIwMjMtMDYtMDZUMDc6MjI6MTguOTE1WiIsInB1ciI6ImNvb2tpZS5yZW1lbWJlcl91c2VyX3Rva2VuIn19--fb11a6f1a5b2dcf09034a6e8f5fc1e74ae7457c7" }
